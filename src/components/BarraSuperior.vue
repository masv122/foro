<template>
  <div>
    <b-navbar class="shadow-sm fixed-top" type="primary" variant="light">
      <!-- <b-navbar-brand ></b-navbar-brand> -->
      <b-navbar-nav class="mr-auto nav-left">
        <div class="d-blocks text-center mr-3" v-if="usuario != null">
        ...
        <b-nav-form>
          ...
          </b-form-group> </b-nav-form
      ></b-navbar-nav>
      <b-navbar-nav class="mx-auto nav-center">
        <b-nav-item :to="{ name: 'Home' }">
          <i class="fa fa-home" aria-hidden="true"></i>
        </b-nav-item>
        <b-nav-item><i class="fa fa-fire" aria-hidden="true"></i></b-nav-item>
        <b-nav-item><i class="fa fa-star" aria-hidden="true"></i></b-nav-item>
      </b-navbar-nav>
      <b-navbar-nav class="ml-auto nav-right">
        <b-nav-item href="#" v-if="usuario != null"
          ><i class="fa fa-user-circle"></i>
        </b-nav-item>
        <b-nav-item v-if="usuario != null"
        ...
        <b-nav-item v-if="usuario != null"
          ...
          ></b-nav-item
        >
        <b-nav-item-dropdown no-caret right v-if="usuario != null">
          ...
          >
          <b-dropdown-item :to="{ name: 'Login' }" @click="logOut"
